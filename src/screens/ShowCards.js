...
//attempt to invoke interface method 'boolean com.facebook.react.bridge.ReadableMap.
//hasKey(java.lang.String)' on a null object reference

//Attempt to invoke interface method 'android.content.res.XmlResourceParser 
//android.content.pm.PackageItemInfo.loadXmlMetaData(android.content.pm.PackageManager,
//java.lang.String)' on a null object reference
// ... removed two lines from /android/src/main/AndroidMainfest.xml (inside provider) ...
// ... and then put them back in but changed the provider to com.tracksome.provider ...
//        <meta-data
...
*/
  ...
  onCardItemMenuPress(option, card) {
    switch (option) {
      ...
      case 'share': {
        // ... here we are going to share this drop on social media / email ...
        this.shareDropWithOthers(card);
        break;
      }
      case 'delete': {
...
//twitter, facebook, whatsapp, googleplus, email
        ...
        <Button 
          ...
          onPress={() => {
            ...
            setTimeout(() => {
              ...
              .catch(err => ToastAndroid.show(`Error: ${JSON.stringify(err)}`, ToastAndroid.LONG));
            }, 300);
          }}
        >Facebook</Button>
        <Button 
